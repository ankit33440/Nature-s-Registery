      ...
      <div className="relative z-10 flex flex-col h-full p-10 xl:p-14">
        ...
        <div className="flex-1 flex flex-col justify-center mt-12">
          ...
          <h2 className="text-4xl xl:text-5xl font-bold text-white leading-tight mb-6">
            ...
            <span className="text-green-400">one credit</span>
            <br />at a time.
          </h2>
          <p className="text-green-300/80 text-sm leading-relaxed max-w-xs">
            A trusted platform for monitoring, reporting, and verification of
            carbon credits across the full MRV lifecycle.
          </p>
            ...
            {[
              {
                ...
                desc: 'Full MRV lifecycle management',
              },
              {
                title: 'Transparent Reporting',
                desc: 'Real-time monitoring & audit trails',
              },
              {
                title: 'Trusted Marketplace',
                desc: 'Secure issuance and trading',
              },
            ].map((item) => (
          ...
          <form onSubmit={(e) => void handleSubmit(e)} noValidate>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className={`w-full px-4 py-3 rounded-xl border text-sm bg-white text-stone-900 placeholder-stone-400 transition-shadow focus:outline-none focus:ring-2 focus:ring-green-500/40 focus:border-green-500 ${
                  errors.email
            ...
            >
              {isSubmitting ? (
                ...
                <svg className="w-4 h-4 opacity-80" viewBox="0 0 16 16" fill="none">
                  <path d="M8 1.5C8 1.5 2.5 4.5 2.5 9C2.5 12.3 5 15 8 15C11 15 13.5 12.3 13.5 9C13.5 4.5 8 1.5 8 1.5Z" fill="currentColor" fillOpacity="0.7"/>
                  <path d="M8 15V8" stroke="white" strokeWidth="1.2" strokeLinecap="round"/>
                </svg>
              )}
